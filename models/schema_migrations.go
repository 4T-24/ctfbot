...
var (
	schemaMigrationAllColumns            = []string{"version"}
	schemaMigrationColumnsWithoutDefault = []string{}
...
func FindSchemaMigrationG(ctx context.Context, version null.String, selectCols ...string) (*SchemaMigration, error) {
...
func SchemaMigrationExistsG(ctx context.Context, version null.String) (bool, error) {
