...
type Setting struct {
	...
	V string `boil:"v" json:"v" toml:"v" yaml:"v"`
...
var SettingWhere = struct {
	...
	K: whereHelperstring{field: "\"settings\".\"k\""},
	V: whereHelperstring{field: "\"settings\".\"v\""},
}
...
var (
	settingAllColumns            = []string{"k", "v"}
	settingColumnsWithoutDefault = []string{"k", "v"}
	settingColumnsWithDefault    = []string{}
	settingPrimaryKeyColumns     = []string{"k"}
...
// OneG returns a single setting record from the query using the global executor.
func (q settingQuery) OneG(ctx context.Context) (*Setting, error) {
...
// AllG returns all Setting records from the query using the global executor.
func (q settingQuery) AllG(ctx context.Context) (SettingSlice, error) {
...
// CountG returns the count of all Setting records in the query using the global executor
func (q settingQuery) CountG(ctx context.Context) (int64, error) {
...
func (q settingQuery) ExistsG(ctx context.Context) (bool, error) {
...
// FindSettingG retrieves a single record by ID.
func FindSettingG(ctx context.Context, k string, selectCols ...string) (*Setting, error) {
	return FindSetting(ctx, boil.GetContextDB(), k, selectCols...)
}

// FindSetting retrieves a single record by ID with an executor.
// If selectCols is empty Find will return all columns.
func FindSetting(ctx context.Context, exec boil.ContextExecutor, k string, selectCols ...string) (*Setting, error) {
	settingObj := &Setting{}
	...
	query := fmt.Sprintf(
		"select %s from \"settings\" where \"k\"=?", sel,
	)
...
func (o *Setting) InsertG(ctx context.Context, columns boil.Columns) error {
...
// UpdateG a single Setting record using the global executor.
// See Update for more documentation.
func (o *Setting) UpdateG(ctx context.Context, columns boil.Columns) (int64, error) {
...
func (q settingQuery) UpdateAllG(ctx context.Context, cols M) (int64, error) {
...
// UpdateAllG updates all rows with the specified column values.
func (o SettingSlice) UpdateAllG(ctx context.Context, cols M) (int64, error) {
...
func (o *Setting) UpsertG(ctx context.Context, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
...
// DeleteG deletes a single Setting record.
// DeleteG will match against the primary key column to find the record to delete.
func (o *Setting) DeleteG(ctx context.Context) (int64, error) {
...
func (o *Setting) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"settings\" WHERE \"k\"=?"
...
func (q settingQuery) DeleteAllG(ctx context.Context) (int64, error) {
...
func (o SettingSlice) DeleteAllG(ctx context.Context) (int64, error) {
...
func (o *Setting) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("models: no Setting provided for reload")
	}
...
func (o *Setting) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindSetting(ctx, exec, o.K)
	if err != nil {
		return err
	}
...
func (o *SettingSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("models: empty SettingSlice provided for reload all")
	}
...
// SettingExistsG checks if the Setting row exists.
func SettingExistsG(ctx context.Context, k string) (bool, error) {
	return SettingExists(ctx, boil.GetContextDB(), k)
}

// SettingExists checks if the Setting row exists.
func SettingExists(ctx context.Context, exec boil.ContextExecutor, k string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"settings\" where \"k\"=? limit 1)"
...
func (o *Setting) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return SettingExists(ctx, exec, o.K)
}
